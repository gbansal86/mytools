...
## v2.0 fixed-launcher repository edition — 2026-09-22

- Published as a self-contained folder in `gbansal86/mytools`.
- Added beginner-friendly GitHub README and quick-start guide.
- Added safety, troubleshooting, source map and known-limitations documentation.
- Added four annotated SVG usage diagrams.
